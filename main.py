...
# storing the model in the shared memory of the computer, 
# which allows the threads to have access to this shared memory even if they are in different cores
...
# same, we store the optimizer in the shared memory so that all the agents can have access to this shared memory to optimize the model
